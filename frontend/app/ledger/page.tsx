...
export default function LedgerPage() {
  ...
  const handleAddEntry = async () => {
    try {
      ...
      setForm({ type: "CREDIT", amount: 0, description: "" });
      setShowForm(false);
      fetchLedger();
    } catch (err) {
      console.error(err);
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-100 bg-gray-50">
              ...
              <th className="text-left text-soft px-6 py-4 font-medium">Description</th>
              <th className="text-left text-soft px-6 py-4 font-medium">Type</th>
              <th className="text-left text-soft px-6 py-4 font-medium">Reference</th>
            ...
            {loading ? (
              ...
              data.entries.map((entry) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-beige">{entry.description}</td>
                  ...
                  <td className="px-6 py-4 text-soft text-xs">{entry.refType}</td>
